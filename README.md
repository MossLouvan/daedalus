...
<img width="100%" src="https://capsule-render.vercel.app/api?type=rect&height=180&color=24292F&text=Daedalus&fontColor=ffffff&fontSize=78&fontAlignY=46&desc=an%20LLM%20agent%20that%20forges%20its%20own%20tools&descAlignY=70&descSize=18&descColor=C9D1D9" alt="Daedalus" />

<a href="https://github.com/MossLouvan/daedalus">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=600&size=22&duration=3000&pause=900&color=E6EDF3&center=true&vCenter=true&width=560&height=45&lines=Forges+its+own+tools;Boots+with+3+tools%2C+builds+the+rest;Forge+to+sandbox-test+to+persist+to+reuse;Runs+on+Claude%2C+GPT%2C+or+local+models" />
    <source media="(prefers-color-scheme: light)" srcset="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=600&size=22&duration=3000&pause=900&color=1F2328&center=true&vCenter=true&width=560&height=45&lines=Forges+its+own+tools;Boots+with+3+tools%2C+builds+the+rest;Forge+to+sandbox-test+to+persist+to+reuse;Runs+on+Claude%2C+GPT%2C+or+local+models" />
    <img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=600&size=22&duration=3000&pause=900&color=1F2328&center=true&vCenter=true&width=560&height=45&lines=Forges+its+own+tools;Boots+with+3+tools%2C+builds+the+rest;Forge+to+sandbox-test+to+persist+to+reuse;Runs+on+Claude%2C+GPT%2C+or+local+models" alt="" />
  </picture>
</a>

<br>

[![Python](https://img.shields.io/badge/Python-3.10+-555555?style=for-the-badge&logo=python&logoColor=white)](https://www.python.org)
[![Claude API](https://img.shields.io/badge/Claude_API-555555?style=for-the-badge&logo=anthropic&logoColor=white)](https://docs.anthropic.com)
[![Tests](https://img.shields.io/badge/tests-19_passing-555555?style=for-the-badge&logo=pytest&logoColor=white)](#verified)
[![License](https://img.shields.io/badge/License-MIT-555555?style=for-the-badge)](LICENSE)
[![Stars](https://img.shields.io/github/stars/MossLouvan/daedalus?style=for-the-badge&color=555555)](https://github.com/MossLouvan/daedalus/stargazers)
<br>
[![Models](https://img.shields.io/badge/runs_on-Claude%20%C2%B7%20OpenAI%20%C2%B7%20Ollama%20%C2%B7%20local-555555?style=for-the-badge)](#run-it-with-any-model)
...
The interesting part isn't "an LLM that writes code"; it is the **closed loop**: the
...
flowchart LR
    ...
    classDef forge fill:#30363d,stroke:#8b949e,color:#ffffff;
    classDef store fill:#21262d,stroke:#8b949e,color:#ffffff;
    class D,E forge;
    class F store;
```
...
5. **Persist and reuse.** Passing tools are saved to `tools_generated/` and registered
...
|---|---|---|
| `DAEDALUS_PROVIDER` | `anthropic` | `anthropic`, `openai`, or `ollama` |
| `DAEDALUS_MODEL` | per-provider | universal model override |
| `ANTHROPIC_API_KEY` | (none) | required for the Anthropic provider |
| `OPENAI_API_KEY` | (none) | key for OpenAI / compatible hosts |
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=rect&height=80&color=24292F&section=footer" alt="" />
